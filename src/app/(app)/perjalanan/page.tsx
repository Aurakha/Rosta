              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-xs text-slate-600 font-medium mt-0.5">
                    {selectedTrip.karyawan?.jabatan || 'Karyawan'} · {selectedTrip.karyawan?.departemen || ''}
                  </div>
                  <div className="text-[11px] text-slate-400 mt-1 flex items-center gap-2 flex-wrap">
                    <span>NIK: <strong className="text-slate-600">{selectedTrip.nik}</strong></span>
              ...
              {selectedTrip.karyawan?.no_hp && (
                <div className="flex flex-col items-end gap-1 shrink-0">
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="inline-flex items-center gap-1.5 px-2.5 py-1.5 rounded-xl bg-emerald-600 hover:bg-emerald-700 text-white text-[11px] font-bold shadow-xs transition"
                  >
