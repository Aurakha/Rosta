...
-- FULL CONSOLIDATED SCHEMA (Jalankan di Supabase SQL Editor)
-- ==============================================================================
...
create table siklus_roster (
  ...
  hari_libur_snapshot      integer not null,
...
-- 9. Generator Nomor Dokumen & RPC Transaksional
...
create or replace function catat_keberangkatan(
  ...
  p_kompensasi_remote     integer default null
) returns void
language plpgsql
as $$
declare
